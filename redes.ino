...
void setup() {
 //Abre a comunicação serial
  ...
  // seta o pino 4 como saida de 5v para o led
      ...
      if (cliente.available()) {
        ...
        if (readString.length() < 100) {
         ...
         if (c == '\n') {          
           ...
           cliente.println("<td>Ligar</td>");
           cliente.println("<td>Desligar</td>");
           cliente.println("</tr>");
           cliente.println("<tr>");
           ...
           cliente.println("<a href=\"/?button1on\"\">Abrir Portão</a>");
           cliente.println("<a href=\"/?button1off\"\">Fechar Portão</a><br />");   
           cliente.println("<br />");     
           cliente.println("<br />"); 
           cliente.println("<br />"); 

           // led 5
           cliente.println("<a href=\"/?button3on\"\">Ligar Arcondicionado</a>");
           cliente.println("<a href=\"/?button3off\"\">Desligar Arcondicionado</a><br />");
           cliente.println("<br />");
           cliente.println("<br />"); 
           cliente.println("<br />");  
           
           //led 6
           cliente.println("<a href=\"/?button3on\"\">Ligar Luzes</a>");
           cliente.println("<a href=\"/?button3off\"\">Desligar Luzes</a><br />");
           cliente.println("<br />"); 
           cliente.println("</BODY>");
           cliente.println("</HTML>");
           ...
           //Arcondicionado mudar as portas!!!!!!!!!!!!!!!!!!!!
